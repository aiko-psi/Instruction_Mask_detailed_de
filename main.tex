...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Fertig angenähtes Nackenband}
        \label{Strap4}
    \end{subfigure}
    \caption{Nackenband}
    \label{Strap}
